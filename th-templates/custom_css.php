...
$typo_area = th_get_option('typo_area');
$typo_heading = th_get_option('typo_heading');
$typography_style = th_get_option('typography_style');
$typo_data = array();
$i = 0;
foreach ($typo_area as $typo_area_value) {
    $typo_data[$i] = array(
       'typo_area' => $typo_area[$i],
       'typo_heading' => $typo_heading[$i],
       'typography_style' => $typography_style[$i],
    );
    $i++;
}
