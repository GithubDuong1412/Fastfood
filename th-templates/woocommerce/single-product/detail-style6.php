...
remove_action( 'woocommerce_after_single_product_summary','th_product_tabs_before',5 );
remove_action( 'woocommerce_after_single_product_summary','th_product_tabs',10 );
remove_action( 'woocommerce_after_single_product_summary','th_product_tabs_after',15 );
th_set_post_view();
...
?>
<div class="product-detail product-detail-style3 detail-style6">
    <div class="row">
                ...
                <div class="wrap-detail-gallery images <?php echo esc_attr($zoom_style)?>">
                    ...
                    <ul class="list-none">
                        ...
                        foreach ( $attachment_ids as $attachment_id ) {
                            ...
                            $html = wp_get_attachment_image($attachment_id,array(600,600),false,$attributes );
                            echo   '<li>
        ...
        <div class="<?php echo esc_attr($info_class)?>">
            <div class="summary entry-summary detail-info info-sticky">
                <h2 class="product-title titlelv1"><?php the_title()?></h2>
                <?php
                    do_action( 'woocommerce_single_product_summary' );
                    if(function_exists('th_product_tabs_before')) th_product_tabs_before();
                    if(function_exists('th_product_tabs')) th_product_tabs();
                    if(function_exists('th_product_tabs_after')) th_product_tabs_after();
                ?>
            </div>
        </div>
    </div>
