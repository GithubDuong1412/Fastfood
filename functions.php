 ...
 * @date 12.08.2015
 */
load_theme_textdomain( 'autopart', get_template_directory() . '/languages' );
...
require_once( trailingslashit( get_template_directory() ). '/th-lib/controler/Taxonomy-Control.php' );
