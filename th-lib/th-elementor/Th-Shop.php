...
class Th_Shop extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Shop', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'elth-product-list'		=> esc_html__( 'List', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Style 1 - default', 'autopart' ),
		...
		$this->start_controls_section(
			'section_list',
			[
				'label' => esc_html__( 'List', 'autopart' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);		
		...
		$this->start_controls_section(
			'section_top_filter',
			[
				'label' => esc_html__( 'Top filter', 'autopart' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'show_type',
			[
				'label' => esc_html__( 'Type', 'autopart' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'autopart' ),
				'label_off' => esc_html__( 'Off', 'autopart' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Filter button', 'autopart' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
	...
	protected function render() {
        ...
        if(class_exists('Elementor\WC_Query')) $_chosen_attributes = WC_Query::get_layered_nav_chosen_attributes();
        else{
        	$_chosen_attributes = [];
