...
class Th_Price_Table extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Price Table (TH)', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'price-table-default'		=> esc_html__( 'Default', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'duration',
			[
				'label' => esc_html__( 'Duration', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default'   => 'Per month',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Purchase' , 'autopart' ),
			]
		);
