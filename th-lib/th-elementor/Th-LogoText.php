...
class Th_LogoText extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Logo Text', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Add Your Heading Text Here', 'autopart' ),
			]
		);
		...
		$this->add_control(
			'header_size',
			[
				'label' => esc_html__( 'HTML Tag', 'autopart' ),
		...
		$this->add_responsive_control(
			'display',
			[
				'label' => esc_html__( 'Display', 'autopart' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'inline-block' => [
						'title' => esc_html__( 'Inline Block', 'autopart' ),
						'icon' => 'eicon-text-align-left',
					],
					'block' => [
						'title' => esc_html__( 'Block', 'autopart' ),
						'icon' => 'eicon-text-align-center',
					],
				],
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'autopart' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Default', 'autopart' ),
					'stacked' => esc_html__( 'Stacked', 'autopart' ),
					'framed' => esc_html__( 'Framed', 'autopart' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			'shape',
			[
				'label' => esc_html__( 'Shape', 'autopart' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => esc_html__( 'Circle', 'autopart' ),
					'square' => esc_html__( 'Square', 'autopart' ),
				],
				'default' => 'circle',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			'primary_color',
			[
				'label' => esc_html__( 'Primary Color', 'autopart' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'secondary_color',
			[
				'label' => esc_html__( 'Secondary Color', 'autopart' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_responsive_control(
			'rotate',
			[
				'label' => esc_html__( 'Rotate', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'default' => [
					'size' => 0,
		...
		$this->add_control(
			'border_width',
			[
				'label' => esc_html__( 'Border Width', 'autopart' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
