...
class Th_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					''		=> esc_html__( 'Default', 'autopart' ),
					'style2'		=> esc_html__( 'Style2', 'autopart' ),
					'megacontent'	=> esc_html__( 'Mega content', 'autopart' ),
				],
			]
		);
		...
		$repeater_sliders->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => "",
				'placeholder' => esc_html__( 'Enter text' , 'autopart' ),
				'label_block' => true,
			]
		);
		$repeater_sliders->add_control(
			'button_style',
			[
				'label' 	=> esc_html__( 'Button Style', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'autopart' ),
		...
		$repeater_sliders->add_control(
			...
			[
				'label' => esc_html__( 'Overlay background', 'autopart' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'list_items',
			[
				'label' => esc_html__( 'Add mega item', 'autopart' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_contents->get_controls(),
				'title_field' => esc_html__( 'Page ID: {{{megapage}}}', 'autopart' ),
				'condition' => [
					'style' => 'megacontent',
				]
			]
		...
		$this->start_controls_section(
			'section_style_box',
			[
				'label' => esc_html__( 'Box item', 'autopart' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
