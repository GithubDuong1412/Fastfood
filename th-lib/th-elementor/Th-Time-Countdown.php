...
class Th_Time_Countdown extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Time Countdown', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'date_time',
			[
				'label' => esc_html__( 'Choose Date Time', 'autopart' ),
		...
		$this->add_control(
			'show_canvas',
			[
				'label' => esc_html__( 'Show canvas', 'autopart' ),
		...
		$this->add_control(
			'show_day',
			[
				'label' => esc_html__( 'Show day', 'autopart' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'autopart' ),
				'label_off' => esc_html__( 'Off', 'autopart' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_text',
			[
				'label' => esc_html__( 'Show text', 'autopart' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'autopart' ),
				'label_off' => esc_html__( 'Off', 'autopart' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'day_text', 
			[
				'label' => esc_html__( 'Day text', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html('Days','autopart'),
				'condition' => [
					'show_text' => 'yes',
				]
			]
		...
		$this->add_control(
			'day_hour', 
			[
				'label' => esc_html__( 'Hour text', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html('Hours','autopart'),
				'condition' => [
					'show_text' => 'yes',
				]
			]
		...
		$this->add_control(
			'day_mins', 
			[
				'label' => esc_html__( 'Minute text', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html('Minutes','autopart'),
				'condition' => [
					'show_text' => 'yes',
				]
			]
		...
		$this->add_control(
			'day_secs', 
			[
				'label' => esc_html__( 'Second text', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html('Seconds','autopart'),
				'condition' => [
					'show_text' => 'yes',
				]
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Canvas & Wrap', 'autopart' ),
		...
		$this->add_control(
			'align',
			[
				'label' 	=> esc_html__( 'Align', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
		...
		$this->add_control(
			'circle_bg',
			[
				'label' => esc_html__( 'Circle background', 'autopart' ),
				'type' => Controls_Manager::COLOR,
				'condition' => [
					'show_canvas' => 'yes',
					'style!'      => 'style3',
		...
		$this->add_responsive_control(
			'fg_width',
			[
				'label' => esc_html__( 'Circle width', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'description'	=> esc_html__( 'Default 0.03', 'autopart' ),
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
						'min' => 0.01,
		...
		$this->add_responsive_control(
			'bg_width',
			[
				'label' => esc_html__( 'Circle background width', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'description'	=> esc_html__( 'Default 1', 'autopart' ),
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
						'min' => 0.1,
		...
		$this->add_responsive_control(
			...
			[
				...
				'description' => esc_html__( 'Default 20%', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
