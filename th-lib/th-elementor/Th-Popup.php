...
class Th_Popup extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Popup', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'onload',
				'options'   => [
					'onload'		=> esc_html__( 'On Load', 'autopart' ),
					'clickid'	=> esc_html__( 'Click', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'id_show', 
			[
				'label' => esc_html__( 'ID open', 'autopart' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Popup box', 'autopart' ),
