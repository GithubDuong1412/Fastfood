...
class Th_Instagram extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Instagram', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-instagram-grid'		=> esc_html__( 'Grid', 'autopart' ),
					'elth-instagram-slider'	=> esc_html__( 'Slider', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'media_from',
			[
				'label' 	=> esc_html__( 'Media from', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'username',
				'options'   => [
					'username'		=> esc_html__( 'Username', 'autopart' ),
					'media-lib'		=> esc_html__( 'Media library', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'username', 
			[
				'label' => esc_html__( 'User name', 'autopart' ),
		...
		$this->add_control(
			'token', 
			[
				'label' => esc_html__( 'Token', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'number',
			[
				'label' => esc_html__( 'Photos number', 'autopart' ),
		...
		$this->add_control(
			'photos_size',
			[
				'label' 	=> esc_html__( 'Image size', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
					'0'		=> esc_html__( 'Small', 'autopart' ),
					'1'		=> esc_html__( 'Medium', 'autopart' ),
					'2'		=> esc_html__( 'Large', 'autopart' ),
				],
				'condition' => [
					'media_from' => 'username',
				]
		...
		$this->add_control(
			'text_hover', 
			[
				'label' => esc_html__( 'Text hover', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'list_images',
			[
				'label' => esc_html__( 'Add images', 'autopart' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_images->get_controls(),
				'title_field' => esc_html__( 'Item', 'autopart' ),
				'condition' => [
		...
		$this->add_control(
			'color_icon',
			[
				'label' => esc_html__( 'Color icon', 'autopart' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography text hover', 'autopart' ),
