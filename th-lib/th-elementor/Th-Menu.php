...
class Th_Menu extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu', 'autopart' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
            'content_tab',
            [
                'label' => esc_html__('Menu settings', 'autopart'),
        ...
        $this->add_control(
            'nav_menu',
            [
                'label'     =>esc_html__( 'Select menu', 'autopart' ),
		...
		$this->add_control(
			'main_menu_style',
			[
				'label' => esc_html__( 'Menu style', 'autopart' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => esc_html__( 'Default', 'autopart' ),
					'icon' => esc_html__( 'Menu icon', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'menu_sticky',
			[
				'label' => esc_html__( 'Menu sticky', 'autopart' ),
        ...
        $this->add_responsive_control(
			'main_menu_position',
			[
				'label' => esc_html__( 'Menu position', 'autopart' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left'  => esc_html__( 'Left', 'autopart' ),
					'center' => esc_html__( 'Center', 'autopart' ),
                    'right' => esc_html__( 'Right', 'autopart' ),
                    'justified'  => esc_html__( 'Justified', 'autopart' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
            'content_side_tab',
            [
                'label' => esc_html__('Menu side/mobile', 'autopart'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
		);
		...
		$this->add_control(
			'th_nav_menu_logo',
			[
				'label' => esc_html__( 'Choose Mobile Menu Logo', 'autopart' ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Item text color', 'autopart' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Head Padding', 'autopart' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            'style_tab_menuitem',
            [
                'label' => esc_html__('Menu item style', 'autopart'),
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'autopart' ),
        ...
        $this->add_responsive_control(
			'menu_item_spacing',
			[
				'label' => esc_html__( 'Spacing (a)', 'autopart' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Spacing (li)', 'autopart' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background', 'autopart' ),
					'types' => ['classic', 'gradient'],
					'selector' => '{{WRAPPER}} .th-navbar-nav > li > a',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .th-navbar-nav > li > a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_group_control(
				Group_Control_Border::get_type(),
				[
					'name' => 'menu_item0_border_hover',
					'label' => esc_html__( 'Border', 'autopart' ),
					'selector' => '{{WRAPPER}} .th-navbar-nav > li > a:hover',
				]
			);

			$this->add_responsive_control(
				'menu_text_border_hover',
				[
					'label' => esc_html__( 'Border Radius', 'autopart' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .th-navbar-nav > li > a:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (Active)', 'autopart' ),
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'selectors' => [
			...
			$this->add_responsive_control(
				'menu_text_border_active',
				[
					'label' => esc_html__( 'Border Radius', 'autopart' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .th-navbar-nav > li.current-menu-item > a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .th-navbar-nav > li.current-menu-ancestor > a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Items Border', 'autopart' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Last Child', 'autopart' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border First Child', 'autopart' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu item style', 'autopart'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Submenu Indicator', 'autopart' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'th_line_arrow',
				'options' => [
					'th_line_arrow'  => esc_html__( 'Line Arrow', 'autopart' ),
					'th_plus_icon' => esc_html__( 'Plus', 'autopart' ),
					'th_fill_arrow' => esc_html__( 'Fill Arrow', 'autopart' ),
					'th_none' => esc_html__( 'None', 'autopart' ),
                ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator color', 'autopart' ),
				'type' => Controls_Manager::COLOR,
				'devices' => [ 'desktop', 'tablet' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator Margin', 'autopart' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Spacing', 'autopart' ),
                'type' => Controls_Manager::DIMENSIONS,
				'devices' => [ 'desktop', 'tablet' ],
                'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (hover)', 'autopart' ),
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'selectors' => [
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background (hover)', 'autopart' ),
					'types' => [ 'classic', 'gradient' ],
					'selector' => '
			...
			$this->add_group_control(
				...
				[
					...
					'label' 	=> esc_html__( 'Item background (Active)', 'autopart' ),
					'types'		=> ['classic', 'gradient'],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sub Menu Items Border', 'autopart' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu panel style', 'autopart'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Panel Menu Border', 'autopart' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Container background', 'autopart' ),
                'types' => [ 'classic','gradient' ],
                'selector' => '{{WRAPPER}} .th-navbar-nav .sub-menu',
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container width', 'autopart' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon menu Style', 'autopart' ),
                'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Icon menu Toggle', 'autopart' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Position', 'autopart' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Size height', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Humber Icon Color', 'autopart' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Close Toggle', 'autopart' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Menu Logo', 'autopart' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		if($settings['nav_menu'] != '' && wp_get_nav_menu_items($settings['nav_menu']) !== false){
			...
			if(isset($settings['th_nav_menu_logo']['url']) && !empty($settings['th_nav_menu_logo']['url'])){
				$logo_mobile = 	'<a class="mobile-logo" href="'.home_url('/').'">
									<img src="'.$settings['th_nav_menu_logo']['url'].'" alt="'.esc_attr__("logo mobile","autopart").'" >
								</a>';
			}
			...
			echo 	'<div class="th-menu-container th-menu-offcanvas-elements th-navbar-nav-default ' .$settings['style_tab_submenu_item_arrow'].' menu-style-'.$settings['main_menu_style'].' default-'.$settings['main_menu_style'].' '.$sticky_class.'">
						'.$icon_html.'
