...
class Th_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'button_size',
			[
				'label' 	=> esc_html__( 'Button size', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'autopart' ),
					'elth-bt-medium'		=> esc_html__( 'Medium', 'autopart' ),
					'elth-bt-large'		=> esc_html__( 'Large', 'autopart' ),
					'elth-bt-extra-large'		=> esc_html__( 'Extra Large', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'button_text', 
			[
				'label' => esc_html__( 'Text button', 'autopart' ),
				'description' => esc_html__( 'Enter text of button', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default'   => esc_html__( 'Read more', 'autopart' ),
				'placeholder' => esc_html__( 'Read more', 'autopart' ),
			]
		);
