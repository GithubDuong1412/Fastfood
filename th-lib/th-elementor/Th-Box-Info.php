...
class Th_Box_Info extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Box Info', 'autopart' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header', 'autopart' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Header', 'autopart' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'autopart' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Title', 'autopart' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Description', 'autopart' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'form',
			[
				'label' 	=> esc_html__( 'Add form', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
		...
		$repeater_icons->add_responsive_control(
			'icon_space',
			[
				'label' => esc_html__( 'Icon Space', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$repeater_icons->add_responsive_control(
			'title_space',
			[
				'label' => esc_html__( 'Title Space', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$repeater_icons->add_responsive_control(
			'description_space',
			[
				'label' => esc_html__( 'Description Space', 'autopart' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_control(
			'list_icons',
			[
				'label' => esc_html__( 'Add icons', 'autopart' ),
		...
		$this->add_control(
			'icon_style',
			[
				'label' 	=> esc_html__( 'Style icon', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Default', 'autopart' ),
				],
			]
		);
		...
		$this->add_control(
			'image_style',
			[
				'label' 	=> esc_html__( 'Style image', 'autopart' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Default', 'autopart' ),
		...
		$this->add_control(
			'check_button',
			[
				'label' => esc_html__( 'Show button', 'autopart' ),
		...
		$this->add_control(
			'button_text', 
			[
				'label' => esc_html__( 'Button Text', 'autopart' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'check_submit',
			[
				'label' => esc_html__( 'Click submit form', 'autopart' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'autopart' ),
				'label_off' => esc_html__( 'Off', 'autopart' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_style_wrap',
			[
				'label' => esc_html__( 'Wrap Box', 'autopart' ),
