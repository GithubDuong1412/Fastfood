...
if(!function_exists('th_set_theme_config')){
    function th_set_theme_config(){
        ...
        $th_config['nav_menu'] = array(
            'primary' => esc_html__( 'Primary Navigation', 'autopart' ),
        );
        $th_config['mega_menu'] = '1';
        $th_config['sidebars']=array(
            array(
                'name'              => esc_html__( 'Blog Sidebar', 'autopart' ),
                'id'                => 'blog-sidebar',
                'description'       => esc_html__( 'Widgets in this area will be shown on all blog page.', 'autopart'),
        ...
        if(class_exists("woocommerce")){
            $th_config['sidebars'][] = array(
                'name'              => esc_html__( 'WooCommerce Sidebar', 'autopart' ),
                'id'                => 'woocommerce-sidebar',
                'description'       => esc_html__( 'Widgets in this area will be shown on all woocommerce page.', 'autopart'),
                'before_title'      => '<h3 class="widget-title"><span>',
                'after_title'       => '</span></h3>',
                'before_widget'     => '<div id="%1$s" class="sidebar-widget widget %2$s">',
                'after_widget'      => '</div>',
        ...
        $th_config['import_theme_option'] = '{"last_tab":"1","th_header_page":"6012","th_footer_page":"6016","th_404_page":"","th_404_page_style":"","th_show_breadrumb":"","th_bg_breadcrumb":{"background-color":"","background-repeat":"","background-size":"","background-attachment":"","background-position":"","background-image":"","media":{"id":"","height":"","width":"","thumbnail":""}},"breadcrumb_text":{"font-family":"","font-options":"","google":"1","font-weight":"","font-style":"","subsets":"","text-align":"","font-size":"","line-height":"","color":""},"breadcrumb_text_hover":{"font-family":"","font-options":"","google":"1","font-weight":"","font-style":"","subsets":"","text-align":"","font-size":"","line-height":"","color":""},"show_preload":"1","preload_bg":{"background-color":"#001327","background-repeat":"no-repeat","background-size":"cover","background-attachment":"","background-position":"center center","background-image":"","media":{"id":"","height":"","width":"","thumbnail":"https:\/\/autopart.ththeme.net\/wp-content\/uploads\/2023\/03\/bg18-150x150.jpg"}},"preload_style":"style8","show_scroll_top":"1","show_wishlist_notification":"","show_too_panel":"","remove_style_content":"","tool_panel_page":"","body_bg":{"color":"","alpha":"1","rgba":""},"main_color":{"color":"","alpha":"","rgba":""},"main_color2":{"color":"","alpha":"","rgba":""},"th_page_style":"","container_width":"","before_append_post":"6206","after_append_post":"","th_sidebar_position_blog":"right","th_sidebar_blog":"blog-sidebar","blog_sidebar_style":"","blog_default_style":"list","blog_style":"","blog_title":"1","blog_number_filter":"1","blog_number_filter_list":{"redux_repeater_data":[{"title":""}]},"title":["",""],"number":["",""],"blog_type_filter":"1","post_list_size":"","post_list_item_style":"style2","post_grid_column":"2","post_grid_size":"","post_grid_excerpt":"80","post_grid_item_style":"","post_grid_type":"","th_sidebar_position_post":"right","th_sidebar_post":"blog-sidebar","post_sidebar_style":"","post_single_thumbnail":"1","post_single_size":"","post_single_meta":"1","post_single_author":"1","post_single_navigation":"1","post_single_related":"1","post_single_related_title":"","post_single_related_number":"","post_single_related_item":"","post_single_related_item_style":"","th_sidebar_position_page":"no","th_sidebar_page":"","page_sidebar_style":"","th_sidebar_position_page_archive":"right","th_sidebar_page_archive":"blog-sidebar","archive_sidebar_style":"","th_sidebar_position_page_search":"","th_sidebar_page_search":"","search_sidebar_style":"","th_add_sidebar":{"redux_repeater_data":[{"title":""}]},"widget_title_heading":["h3"],"th_custom_typography":{"redux_repeater_data":[{"title":""}]},"typo_area":["body"],"typo_heading":[""],"typography_style":[{"font-family":"","font-options":"","google":"1","font-weight":"","font-style":"","subsets":"","text-align":"","font-size":"","line-height":"","color":""}],"th_sidebar_position_woo":"right","th_sidebar_woo":"woocommerce-sidebar","woo_sidebar_style":"","shop_default_style":"grid","shop_gap_product":"","woo_shop_number":"12","sv_set_time_woo":"","shop_style":"","shop_ajax":"","shop_thumb_animation":"translate-thumb","shop_number_filter":"1","shop_number_filter_list":{"redux_repeater_data":[{"title":""}]},"shop_type_filter":"1","shop_list_size":"","shop_list_item_style":"","shop_grid_column":"3","shop_grid_size":"","shop_grid_item_style":"style4","shop_grid_type":"","cart_page_style":"style2","checkout_page_style":"style2","th_header_page_woo":"","th_footer_page_woo":"","before_append_woo":"6208","after_append_woo":"","product_single_style":"","add_to_cart_sticky":"","sv_sidebar_position_woo_single":"no","sv_sidebar_woo_single":"","woo_single_sidebar_style":"","product_image_zoom":"zoom-style4","product_tab_detail":"tab-style3","show_excerpt":"1","show_latest":"0","show_upsell":"0","show_related":"1","show_single_number":"6","show_single_size":"","show_single_itemres":"","show_single_item_style":"style4","before_append_woo_single":"","before_append_tab":"","after_append_tab":"","after_append_woo_single":"","redux-backup":1}';
        ...
        $th_config['require-plugin'] = array(
            ...
            array(
                'name'      => esc_html__( 'Slider Revolution', 'autopart'),
                'slug'      => 'revslider',
                'required'  => true,
                'source'    => get_template_directory().'/plugins/revslider.zip',
            ),        
            array(
                'name'      => esc_html__( 'Elementor', 'autopart'),
                'slug'      => 'elementor',
                'required'  => true,
            ),
            array(
                'name'      => esc_html__( 'Redux Framework', 'autopart'),
                'slug'      => 'redux-framework',
                'required'  => true,
            ),
            array(
                'name'      => esc_html__( 'WooCommerce', 'autopart'),
                'slug'      => 'woocommerce',
                'required'  => true,
            ),
            array(
                'name'      => esc_html__( 'Contact Form 7', 'autopart'),
                'slug'      => 'contact-form-7',
                'required'  => false,
            ),
            array(
                'name'      => esc_html__('MailChimp for WordPress Lite','autopart'),
                'slug'      => 'mailchimp-for-wp',
                'required'  => false,
            ),
            array(
                'name'      => esc_html__('Yith WooCommerce Compare','autopart'),
                'slug'      => 'yith-woocommerce-compare',
                'required'  => false,
            ),
            array(
                'name'      => esc_html__('Yith WooCommerce Wishlist','autopart'),
                'slug'      => 'yith-woocommerce-wishlist',
                'required'  => false,
            ),
            array(
                'name'      => esc_html__('Dokan – Best WooCommerce Multivendor Marketplace Solution','autopart'),
                'slug'      => 'dokan-lite',
                'required'  => false,
            ),
        );
